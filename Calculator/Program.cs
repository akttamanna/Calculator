...

{
...

    {
        ...
        Console.WriteLine(
            $"Adding {firstNumber} and {secondNumber} equal {result}");
...

    {
        ...
        Console.WriteLine(
            $"Subtracting {firstNumber} from {secondNumber} equal {result}");
...

    {
        ...
        Console.WriteLine(
            $"Dividing {firstNumber} by {secondNumber} equal {result}");
...

    {
        ...
        Console.WriteLine(
            $"Multiplying {firstNumber} by {secondNumber} equal {result}");
